...
<%
    ...
    request.getSession().setAttribute("prevURL", "manager/manager_all_serv");
%>
<ul class="hor">
...
<nav style="background: dimgray">
    <ul>
        <c:if test="${requestScope.currentPage != 1}">
            <li>
                <a href="manager_all_serv?page=${requestScope.currentPage-1}"><%=bundle.getString("pagination.previous")%></a>
            </li>
        </c:if>
        ...
        <c:if test="${requestScope.currentPage lt requestScope.pagesCount}">
            <li>
                <a href="manager_all_serv?page=${requestScope.currentPage+1}"><%=bundle.getString("pagination.next")%></a>
            </li>
        </c:if>
    </ul>
</nav>
